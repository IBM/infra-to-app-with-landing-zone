...
2.  Select the catalog, and click **Add** to add a Product to the new
    ...
    d.  Source URL: TODO: replace with final URL
...
3.  A default name is randomly generated for your deployable
    architecture. To change it:
...
4.  In the next few steps, we edit the information specific to a given version.

    a.  To access the version configuration screens, under the **Version list** section (bottom of the screen), click on the version that  was imported (1.0.0)
    ![](../images/part-2/8189e32b5ed54528a3fe0cd0ab18af214555cc7d.png)

    b.  You should be directed to a screen looking like this:
    ![](../images/part-2/media/image24.png)

5.  Screen **Configure version -- Step 1**: Review the version details,
    and click **Next**

6.  Screen **Configure version -- Step 2:** This screen gives the opportunity to configure (1) the terraform runtime version to execute this version of the Deployable architecture, and (2) configure the terraform input and output variables that are made visible to the end-user in IBM Cloud Projects as well as their type.
...
7.  Screen **Configure version -- Step 3:** This screen allows you to define the IAM access requires to execute. This information is  displayed to the end-users of your deployable architecture tile.
...
8.  Screen: **Add deployable architecture details -- Step 1 -- add
...
9.  Screen **Add deployable architecture details -- Step 2 -- add
...
10. Screen **Add deployable architecture details -- Step 3 -- Add
...
11. Screen **Add license agreements**. This step allows to surface any
    license agreement that users of the deployable architecture must
    accept before deploying. In this lab, we leave the license
    agreements empty.

12. Screen **Edit readme**. By default, the `readme.md` file that is
...
13. Screen **Validate version** - to get the tile visible to other users
...
14. Screen **Review cost.** The cost displayed in this screen are based
    on the resources created in the validation step. You may review the
    estimate and click **Next**.

15. Screen **Manage compliance**. This step enables you to claim
...
16. Screen **Review Requirements**. This screen gives a summary of any
...
17. In order to share the Deployable Architecture with other users in
    ...
    c.  Select **Share to this account**, and click the **Share** button
        at the bottom of the screen. ![](../images/part-2/8d1be5e148980da96710b4ede30117ae9babd529.png)
