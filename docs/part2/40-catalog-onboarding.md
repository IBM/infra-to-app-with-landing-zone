...
1.  Select the catalog, and then click **Add** to add a product to the new catalog offering.
    ...
    - Source URL: `https://github.com/IBM/infra-to-app-with-landing-zone/archive/refs/tags/1.0.4.tar.gz`.

        This URL links to the `tar.gz` asset file that is located in the [GitHub release page](https://github.com/IBM/infra-to-app-with-landing-zone/releases/tag/1.0.4).
    - Variation: **Standard**.
